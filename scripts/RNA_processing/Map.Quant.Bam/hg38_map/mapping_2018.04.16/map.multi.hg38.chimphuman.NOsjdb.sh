...
# star output dir
starout=$path/Aligned_hg38_STAR_mMap.NOsjdb
mkdir $starout
# script output dir
scrout=$path/scripts/mapping_2018.04.16/Align_hg38.mMap.NOsjdb
mkdir $scrout
...
#SBATCH -C mem256GB
#SBATCH -J $sample.m.noS.STAR
#SBATCH -o $sample.m.noS.STAR.out
#SBATCH -e $sample.m.noS.STAR.err
...
STAR --genomeDir /projects/fs1/common/genome/lunarc/indicies/star/human/hg38 \
 ...
 --outFileNamePrefix $starout/hg38.mMap.NOsjdb.$sample" > $scrout/Map_mMap_NOsjdb_hg38.$sample.sh
