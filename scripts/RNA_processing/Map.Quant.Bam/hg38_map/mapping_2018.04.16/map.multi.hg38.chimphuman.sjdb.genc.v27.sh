...
# star output dir
starout=$path/Aligned_hg38_STAR_mMap.sjdb.genc.v27
mkdir $starout
# script output dir
scrout=$path/scripts/mapping_2018.04.16/Align_hg38.mMap.sjdb.genc.v27
mkdir $scrout
...
STAR --genomeDir /projects/fs1/common/genome/lunarc/indicies/star/human/hg38 \
 ...
 --outFileNamePrefix $starout/hg38.mMap.genc.v27.$sample" > $scrout/Map_mMap_sjdb.genc.v27_hg38.$sample.sh
